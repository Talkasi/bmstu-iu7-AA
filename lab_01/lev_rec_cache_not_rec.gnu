...
set title "График сравнения по времени линейного и рекурсивного с\nкешированием алгоритмов поиска расстояния Левенштейна"
set xlabel "N"
set ylabel "T"
...
plot "data/all_mesurements.txt" using 1:2 title "Линейная функция поиска расстояния Левенштейна" with lines linestyle 1, \
...
set output 'docs/inc/img/lev_rec_cache_not_rec.svg'
replot
set output
